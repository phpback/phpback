<div class="col-md-9">
	...
	<form name="post-idea-form" method="post" action="<?php echo base_url() . 'action/newidea'?>">
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" name="title" value="<?php if(@isset($POST['title'])) echo $POST['title'];?>" minlength="8" max="100" required>
	  </div>
	  <div class="form-group">
	  ...
	  <label><?php echo $lang['label_description'];?></label>
	    <textarea class="form-control" rows="4" name="description" minlength="20" max="1500"><?php if(@isset($POST['desc'])) echo $POST['desc'];?></textarea>
	  </div>
