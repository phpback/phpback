...
if ($result->num_rows == 1) {
    ...
    $server->query("INSERT INTO users(name,email,pass,votes,isadmin,banned) VALUES('" . $_POST['adminname'] . "','" . $_POST['adminemail'] . "','" . password_hash($_POST['adminpass'], PASSWORD_DEFAULT) . "', 20, 3,0)");
